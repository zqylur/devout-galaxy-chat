...
class Chat extends Component {
    ...
    componentWillMount() {
        ...
        this.chatRoom = this
            .pusher
            .subscribe('private-devout-galaxy-chat');
    }
                    ...
                    <Col xs={12}>
                        ...
                        <div className="chat-container">
                            <form onSubmit={this.sendMessage}>
                                <Col xs={5} xsOffset={3}>
                                    <FormControl type="text" value={this.state.value} placeholder="Enter message here" onChange={this.handleChange}/>
                                </Col>
                                <Col xs={4}>
